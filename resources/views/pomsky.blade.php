...
@section ( 'content' )
<!-- Full Width Banner Parallax Section -->
<div class="section-block featured-media page-intro tm-slider-parallax-container">
	<div class="tm-slider-container full-width-slider" data-parallax data-parallax-fade-out data-animation="slide" data-scale-under="960">
		<ul class="tms-slides">
			<li class="tms-slide" data-image data-force-fit data-overlay-bkg-color="#333333" data-overlay-bkg-opacity="0.6">
							...
							<div class="column width-6 offset-3">
								<div>
									...
									<p class="tms-caption lead mb-0 mb-mobile-20 color-white opacity-07"
										data-animate-in="preset:slideInUpShort;duration:1000ms;delay:100ms;"
										data-no-scale
									>Cute and silly - a designer breed</p>
								</div>
							</div>
						</div>
					</div>
				</div>
				<img data-src="images/assets/about/pomsky-about-bg.jpg" data-retina src="images/blank.png" alt=""/>
			</li>
		</ul>
	</div>
</div>
...
<div class="section-block replicable-content">
	<div class="row">
		<div class="column width-12">
			...
			<div class="row">
				<div class="column width-12">
					<h3 class="post-title">Our Ideal Pomsky</h3>
			...
			<div class="row">
				<div class="column width-12">
					<h3 class="post-title">Temperament</h3>
					<p class="lead">Eu nostrud minim voluptate aliquip. Nulla aute adipisicing sit duis eu eiusmod voluptate officia adipisicing minim culpa ea et do. Quis minim mollit elit esse do esse laborum ea officia. Fugiat exercitation voluptate occaecat dolore amet non ea velit non excepteur Lorem. Amet eu Lorem duis ullamco reprehenderit.</p>
			...
			<div class="row">
				<div class="column width-12">
					<h3 class="post-title">Intelligence</h3>
					<p class="lead">Eu nostrud minim voluptate aliquip. Nulla aute adipisicing sit duis eu eiusmod voluptate officia adipisicing minim culpa ea et do. Quis minim mollit elit esse do esse laborum ea officia. Fugiat exercitation voluptate occaecat dolore amet non ea velit non excepteur Lorem. Amet eu Lorem duis ullamco reprehenderit.</p>
			...
			<div class="row">
				<div class="column width-12">
					<h3 class="post-title">Size and Weight</h3>
					<p class="lead">Eu nostrud minim voluptate aliquip. Nulla aute adipisicing sit duis eu eiusmod voluptate officia adipisicing minim culpa ea et do. Quis minim mollit elit esse do esse laborum ea officia. Fugiat exercitation voluptate occaecat dolore amet non ea velit non excepteur Lorem. Amet eu Lorem duis ullamco reprehenderit.</p>
				</div>
			</div>
		</div>
...
<!-- About Pomsky Section End -->

<!-- About Pomsky Ad Split Section -->
<div class="section-block pt-40 pb-40 bkg-blue-light">
	<div class="row flex tmh-perspective">
...
<!-- About Pomsky Ad Split Section End -->
@endsection