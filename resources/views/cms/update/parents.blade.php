                ...
                <div class="row mb-1">
                    ...
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <div class="input-group mb-1">
                            ...
                            <input type="text" id="parent_breed" name="parent_breed" class="form-control clear-border @error('parent_breed') is-invalid @enderror" value="{{ $parent->family_breed }}" required>
